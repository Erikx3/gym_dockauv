...
BASE_CONFIG = {
    ...
    "save_path_folder": os.path.join(os.getcwd(), "result_files"),  # Folder name where result files will be stored

    # ---------- RENDER -----------
    "interval_render": 20,  # Interval of episodes on which the simulation should be rendered, set to high if no rendering
